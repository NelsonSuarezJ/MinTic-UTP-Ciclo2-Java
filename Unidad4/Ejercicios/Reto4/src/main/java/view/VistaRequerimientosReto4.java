...
public class VistaRequerimientosReto4 {
    ...
    public static void requerimiento3() {
        ...
        try {
            ArrayList<SumaProveedor> proveedor = controlador.consultarSumaProveedor();
            for (SumaProveedor s : proveedor) {
                System.out.println(s.getSumaCantidades());
            }
    ...
    public static void requerimiento4() {
        ...
        try {
            ...
            for (LiderCiudad l : liderCiudad) {
                System.out.println(l.getNombreLider());
            }
